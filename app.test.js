...
const { createInitialData, getStatus, addUser, canCreateAccount, getDefaultCreatures, deleteCreature, setCreatureTime, deleteUser } = require('./server');
...
test('herkes zamanı elle girebilir', () => {
  const data = createInitialData();
  setCreatureTime(data, 0, '2026-01-01T10:30', { name: 'Deneme', username: 'deneme' });
  assert.equal(data.creatures[0].lastTime, new Date('2026-01-01T10:30').toISOString());
